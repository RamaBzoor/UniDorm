...
const Card = ({
  ...
  const deleteListing = async () => {
    try {
      await firebase.database().ref(`MainListings/${id}`).remove();
      ...
      window.location.reload(); // This forces a refresh to show the updated list
    } catch (error) {
