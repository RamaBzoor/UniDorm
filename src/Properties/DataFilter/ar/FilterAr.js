...
import "../Filter.css";
import PriceFilter from "./PriceFilterAr";
import TypeFilter from "./TypeFilterAr";
import LocationFilter from "./LocationFilterAr";
import AmenitiesFilter from "./AminitiesFilterAr";
import DateFilter from "./DateFilterAr";
import SizeFilter from "./SizeFilterAr";
import RatingFilter from "./RatingFilterAr";
import { AverageRatingProvider } from "../../../AverageRatingContext";
import Icons from "../../../icons";

const FilterAr = ({ listings, setFilteredlistings }) => {
    ...
    <div className="filter">
      ...
      <div className="filterContainer" ref={filterContainer}>
        ...
        <div className="applyButton">
          <button onClick={handleApplyClick}>تطبيق</button>
        </div>
      </div>
    </div>
  );
